...
Version  : 0.634
Release  : 18
URL      : https://cpan.metacpan.org/authors/id/J/JW/JWB/Proc-ProcessTable-0.634.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/J/JW/JWB/Proc-ProcessTable-0.634.tar.gz
...
%prep
%setup -q -n Proc-ProcessTable-0.634
cd %{_builddir}
tar xf %{_sourcedir}/libproc-processtable-perl_0.59-2.debian.tar.xz
cd %{_builddir}/Proc-ProcessTable-0.634
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Proc-ProcessTable-0.634/deblicense/
